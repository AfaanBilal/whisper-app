...
## Introduction
**Whisper** is a micro-blogging platform written in Go, React Native and TypeScript. See [Whisper Server](https://github.com/AfaanBilal/whisper) for the backend API.
